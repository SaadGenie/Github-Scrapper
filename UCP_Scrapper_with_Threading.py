...
def main():
    choice = UCP_Faculty_Menu()
    if choice != '0':
        faculty_urls = {
            '1': 'https://ucp.edu.pk/faculty-of-pharmacy/faculty-members/',
            '2': 'https://ucp.edu.pk/faculty-of-languages-literature/faculty-members/',
            '3': 'https://ucp.edu.pk/faculty-of-information-technology-and-computer-science/faculty-members/',
            '4': 'https://ucp.edu.pk/faculty-of-engineering/faculty-members/',
            '5': 'https://ucp.edu.pk/faculty-of-media-and-mass-communication/faculty-members/',
            '6': 'https://ucp.edu.pk/faculty-of-humanities-and-social-sciences/faculty-members/',
            '7': 'https://ucp.edu.pk/faculty-of-science-technology/faculty-members-2/',
            '8': 'https://ucp.edu.pk/faculty-of-management-sciences/ucp-business-school/faculty-members/',
            '9': 'https://ucp.edu.pk/faculty-of-law/faculty-members/'
        }

        faculty_url = faculty_urls.get(choice)
        futures = []
        with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
            for url in [faculty_url]:
                future = executor.submit(scrape_lecturer_info, url)
        ...
        for future in concurrent.futures.as_completed(futures):
            try:
                ...
                print(f"Scraping generated an exception: {exc}")
